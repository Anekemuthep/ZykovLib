...
/* package zykov-backend-0.1.0.0 */
#ifndef VERSION_zykov_backend
#define VERSION_zykov_backend "0.1.0.0"
#endif /* VERSION_zykov_backend */
#ifndef MIN_VERSION_zykov_backend
#define MIN_VERSION_zykov_backend(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_zykov_backend */
...
#define CURRENT_COMPONENT_ID "zykov-backend-0.1.0.0-inplace-zykov-backend"
